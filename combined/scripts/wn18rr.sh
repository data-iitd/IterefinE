...
do 
	...
	mkdir wn18rr_$episode
	mv out wn18rr_$episode/out
	rm -rf out
	mkdir NN_data
	...
	mv -f *.txt wn18rr_$episode/
	mv -f psl.* wn18rr_$episode/
	mv -f NN_data/ wn18rr_$episode/NN-data/
	mkdir wn18rr_$episode/type_complex
	mkdir wn18rr_$episode/type_complex/model
	mv -f type_complex/*.txt wn18rr_$episode/type_complex/
	mv -f type_complex/model/model.pt wn18rr_$episode/type_complex/model/model.pt
	rm -rf *.txt
	rm -rf psl.* 
	rm -rf NN_data
