...
do 
	...
	mkdir fb15k-237_ConvE_$episode
	mv out fb15k-237_ConvE_$episode/out
	rm -rf out
	mkdir NN_data
	...
	mv -f *.txt fb15k-237_ConvE_$episode/
	mv -f psl.* fb15k-237_ConvE_$episode/
	mv -f NN_data/ fb15k-237_ConvE_$episode/NN-data/
	mkdir fb15k-237_ConvE_$episode/type_complex
	mkdir fb15k-237_ConvE_$episode/type_complex/model
	mv -f type_complex/*.txt fb15k-237_ConvE_$episode/type_complex/
	mv -f type_complex/model/model.pt fb15k-237_ConvE_$episode/type_complex/model/model.pt
	rm -rf *.txt
	rm -rf psl.* 
	rm -rf NN_data
