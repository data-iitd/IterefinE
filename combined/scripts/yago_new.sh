...
do 
	...
	mkdir yago_new_$episode
	mv out yago_new_$episode/out
	rm -rf out
	mkdir NN_data
	...
	mv -f *.txt yago_new_$episode/
	mv -f psl.* yago_new_$episode/
	mv -f NN_data/ yago_new_$episode/NN-data/
	mkdir yago_new_$episode/type_complex
	mkdir yago_new_$episode/type_complex/model
	mv -f type_complex/*.txt yago_new_$episode/type_complex/
	mv -f type_complex/model/model.pt yago_new_$episode/type_complex/model/model.pt
	rm -rf *.txt
	rm -rf psl.* 
	rm -rf NN_data
