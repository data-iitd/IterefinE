...
do 
	...
	mkdir nell_dev_$episode
	mv out nell_dev_$episode/out
	rm -rf out
	mkdir NN_data
	...
	mv -f *.txt nell_dev_$episode/
	mv -f NN_data/ nell_dev_$episode/NN-data/
	mkdir nell_dev_$episode/type_complex
	mkdir nell_dev_$episode/type_complex/model
	mv -f type_complex/*.txt nell_dev_$episode/type_complex/
	mv -f type_complex/model/model.pt nell_dev_$episode/type_complex/model/model.pt
	rm -rf *.txt
	rm -rf psl.* 
	rm -rf NN_data
